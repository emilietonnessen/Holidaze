export const TITLE_HOME: string = "Online booking of hotels, B&Bs and Guesthouses in Bergen! | Holidaze";
export const META_HOME: string = "Explore unique accommodation alternatives in Bergen! At Holidaze you can book Hotels, Beds & Breakfasts, and Guesthouses online. This is where memories last!";

export const TITLE_ESTABLISHMENTS: string = "Establishments | Hotels, B&Bs and Guesthouses - Holidaze";
export const META_ESTABLISHMENTS: string = "Unique and breathtaking Hotels, Beds & Breakfasts, and Guesthouses in Bergen. Start planning your journey now!";
